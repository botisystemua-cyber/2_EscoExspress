...
var PKG_UE_COLS = [
  ...
  'Статус посилки',        // AJ — Зареєстровано/Оформлення/Провірка/Готово/Відправка/Доставка/Доставлено/Повернення/Невідомо
...
function apiGetStats(params) {
  ...
  var stats = {
    ...
    byPkgStatus: { 'Зареєстровано': 0, 'Оформлення': 0, 'Провірка': 0, 'Готово': 0, 'Відправка': 0, 'Доставка': 0, 'Доставлено': 0, 'Повернення': 0, 'Невідомо': 0 },
    totalDebt: 0
  };
...
function apiAddParcel(params) {
  ...
  obj['Статус посилки'] = 'Зареєстровано';
...
function apiTrackParcel(params) {
  ...
  if (params.pkg_id) {
    var statusMap = {
      '1': '', '2': '', '3': 'Відправка',
      '4': 'Відправка', '5': 'Відправка', '6': 'Відправка',
      '7': 'Відправка', '8': 'Відправка', '9': 'Доставлено',
      '10': 'Доставлено', '11': 'Доставлено', '12': '',
      '14': '', '101': 'Невідомо', '102': 'Невідомо',
      '103': '', '104': '', '106': '',
      '111': 'Повернення', '112': 'Повернення'
    };
